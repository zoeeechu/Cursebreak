...
ds_map_add(weapon_list[1], "max_ammo", 3);
ds_map_add(weapon_list[1], "cooldown", 5);
ds_map_add(weapon_list[1], "sprite", spr_rifle);
ds_map_add(weapon_list[1], "recoil", 0);
ds_map_add(weapon_list[1], "damage", 5);
ds_map_add(weapon_list[1], "bullet_speed", 8);
ds_map_add(weapon_list[1], "reload", 100);
